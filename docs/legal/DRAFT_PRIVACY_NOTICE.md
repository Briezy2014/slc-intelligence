# Draft Privacy Notice — SLC Intelligence

**Status:** DRAFT FOR LEGAL COUNSEL REVIEW — NOT APPROVED  
**Version:** 2026-07-30  
**Intended publication path after approval:** `/privacy`

---

## 1. Who we are

SLC Intelligence (“Platform”) is a software service that helps authorized educators and staff manage specialized learning classroom workflows (for example: goals and progress monitoring, behavior observations, interventions, accommodations, services, meetings, family communication drafts, and assistive IEP/ETR/progress document drafting).

This notice explains how information is handled when the Platform is used by a school, district, or other education organization (“Organization”).
...
Retention follows the Organization’s instructions and applicable law. Account-deletion requests are handled through the published account-deletion process and Organization controls.

## 10. Security

The Platform is designed with privacy-conscious controls including encryption in transit, role-based access, tenant isolation, and auditing. No security control eliminates all risk.

## 11. Children’s / student data

The Platform is intended for **Organization staff use**, not for children creating their own accounts. Student information appears only as entered/authorized by the Organization.

## 12. No certification claims

This notice does **not** claim that the Platform is “FERPA-certified,” “HIPAA-compliant,” “SOC 2 certified,” or similarly certified unless counsel later authorizes specific language after a formal assessment.

## 13. Contact

Privacy and legal questions: **[COUNSEL/OPERATOR CONTACT EMAIL — TO BE FILLED]**  
Organization-specific student-record requests: contact the Organization’s records custodian.

## 14. Changes

Material updates to this notice will be posted on this page and dated. Continued use after notice may constitute acceptance where permitted by agreement and law.
