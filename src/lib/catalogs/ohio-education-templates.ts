  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: "localId", label: "Student ID / local identifier", kind: "text", prefillFrom: "localId" },
        {
          key: "gradeLevel",
          label: "Grade level",
          kind: "select",
        ...
        { key: "districtBuilding", label: "District / building", kind: "text" },
        {
          ...
          kind: "select",
          options: ["Initial", "Annual review", "Review/revision", "Amendment", "Manifestation", "Other"],
        },
    ...
    },
    {
      ...
      fields: [
        { key: "parentConcerns", label: "Parent/guardian concerns for enhancing education", kind: "textarea" },
        { key: "studentStrengthsInterests", label: "Student strengths / interests", kind: "textarea" },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "functionalPresentLevels", label: "Functional / behavioral present levels", kind: "textarea" },
        { key: "howDisabilityAffects", label: "How disability affects involvement and progress", kind: "textarea" },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "progressMonitoringPlan", label: "Method / schedule for measuring progress", kind: "textarea" },
        {
          key: "progressReportingMethod",
          label: "Progress reporting to parents",
          kind: "select",
          options: ["Quarterly", "Trimester", "Concurrent with report cards", "Other district schedule"],
        },
      ],
    },
    {
      ...
      fields: [
        ...
        { key: "supportsForSchoolPersonnel", label: "Supports for school personnel", kind: "textarea" },
      ],
    },
    {
      id: "lre-assessment",
      ...
      fields: [
        { key: "lreExplanation", label: "Least restrictive environment explanation", kind: "textarea" },
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: "referralReason", label: "Reason for referral / suspected disability concern", kind: "textarea" },
        { key: "interventionsTried", label: "Interventions / supports already tried", kind: "textarea" },
      ],
    },
    {
      id: "planning",
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "functionalFindings", label: "Functional / adaptive / behavior findings", kind: "textarea" },
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "supportsUsed", label: "Supports / specially designed instruction used", kind: "textarea" },
        {
