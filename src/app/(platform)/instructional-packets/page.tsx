  ...
  return (
    <main id="main-content">
      ...
      <PageHeader
        ...
        description="Turn a learner profile and IEP goal into a differentiated activity packet with visuals, games, assessments, and data sheets — always educator-reviewed."
      />
