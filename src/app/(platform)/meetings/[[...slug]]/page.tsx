  ...
  return (
    <main id="main-content">
      ...
      <PageHeader
        ...
        description="Meetings, participants, notes, action items, and descriptive acknowledgements."
      />
      {!state.configured ? (
        <ConfigurationState />
      ) : state.error ? (
            ...
            links={[
              {
                href: "/meetings",
                label: "Dashboard",
                description: "Review scheduled and draft meetings.",
              },
              {
                href: "/meetings/action-items",
                label: "Action items",
                description: "Track meeting follow-ups.",
              },
              {
                href: "/meetings/types",
                label: "Types",
                description: "Manage meeting types when authorized.",
              },
            ]}
          />
