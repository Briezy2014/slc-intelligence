  ...
  return (
    <main id="main-content">
      ...
      <PageHeader
        ...
        description="Classroom schedule blocks and daily operations for the selected classroom."
      />
      {!state.configured ? (
        <ConfigurationState />
      ) : state.error ? (
        ...
        <ClassroomOperationsWorkspace data={state.data} classroomId={classroomId} />
      )}
    </main>
  );
}
